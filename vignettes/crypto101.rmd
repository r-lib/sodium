...
The implementation of public key encryption requires a [Diffie-Hellman](http://mathworld.wolfram.com/Diffie-HellmanProtocol.html) function: a method which allows two parties that have no prior knowledge of each other to jointly establish a shared secret key over an insecure channel.
